...
<html>
    <head>
        ...
        <script type="text/javascript" src="/js/view/adminfilter.js"></script>
		<link rel="stylesheet" type="text/css" href="ext-patch.css" />
    </head>
    <body>
        <div id="main">
            <div id="head" style="font-weight:bold;font-size:200%;">管理限制IP位址登入後台</div>
